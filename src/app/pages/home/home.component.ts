...
export class HomeComponent {
  private apiUrl = 'https://taskmanager-c5b87-default-rtdb.firebaseio.com'; // Replace with your Firebase RTDB URL
...
pendingTasks: { name: string; category: string }[] = [];
  ...
  //   }
  //   this.completedTasks[category][index] = true; // Mark task as completed
  ...
  // async saveTask() {
  //   if (this.taskName.trim() && this.selectedCategory) {
